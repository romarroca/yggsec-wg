...
class WireGuardService:
    ...
    def _ensure_directories(self) -> None:
        ...
        for directory in [self.config.ROOT_DIR, self.config.keys_dir, self.config.wg_dir]:
...
"""
            ...
            config_path = os.path.join(self.config.wg_dir, f"{spoke_name}-{self.config.WG_IFACE}.conf")
