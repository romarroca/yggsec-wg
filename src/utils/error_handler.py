...
try:
    ...
    class ValidationError(YggSecError): pass
    class NetworkConfigError(YggSecError): pass  
    class WireGuardError(YggSecError): pass
    class FirewallError(YggSecError): pass
    class AuthenticationError(YggSecError): pass
    class PermissionError(YggSecError): pass
    class ServiceError(YggSecError): pass
    class ConfigurationError(YggSecError): pass
...
class ErrorHandler:
    ...
    @classmethod
    def _get_user_message(cls, error: Exception, operation: str = None, sanitize: bool = True) -> str:
    ...
    def _create_log_message(cls, error: Exception, context: str, correlation_id: str) -> str:
        ...
        return (
            f"[{correlation_id}] {error_type} in {context}: {error_msg}"
        )
